...
(
    ...
    $SUDO docker run -it \
    -e GIT_REPO="$GIT_REPO" \
    --name vilight-srcdist-builder-cont \
    -v $FRESH_CLONE_DIR:/opt/vilight \
    --rm \
    --workdir /opt/vilight/contrib/build-linux/srcdist_docker \
    vilight-srcdist-builder-img \
    ./_build.sh $REV

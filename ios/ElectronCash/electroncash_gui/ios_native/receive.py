...
from vilight.util import timestamp_to_datetime, format_time
from vilight.i18n import _, language
from vilight.address import Address, ScriptOutput
from vilight.paymentrequest import PR_UNPAID, PR_EXPIRED, PR_UNKNOWN, PR_PAID
...
class ReceiveVC(ReceiveBase):
    ...
    def onShareRequestBut_(self, sender) -> None:
        ...
        alert = utils.show_alert(vc = self,
                                 ...
                                 message = _("You may share this payment request as a 'vitae:' style URI, or as a QR Code Image."),
                                 actions = actions,
                                 style = UIAlertControllerStyleActionSheet,
                                 cancel = _("Cancel"),
                                 ipadAnchor = ipadAnchor)
